...
import com.groww.tink.aesgcmjce.AesgcmjceApplication;
...
/**
 * AOT generated context for {@code AesgcmjceApplicationTests}.
 */
public class AesgcmjceApplicationTestsContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  ...
  public void initialize(GenericApplicationContext context) {
    ...
    BeanDefinitionRegistrar.of("aesgcmjceApplication", AesgcmjceApplication.class)
        .instanceSupplier(AesgcmjceApplication::new).register(beanFactory);
    org.springframework.boot.autoconfigure.AesgcmjceApplicationTestsContextInitializer.registerAutoConfigurationPackages_BasePackages(beanFactory);
    ...
    org.springframework.boot.autoconfigure.websocket.servlet.AesgcmjceApplicationTestsContextInitializer.registerWebSocketServletAutoConfiguration_TomcatWebSocketConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.websocket.servlet.AesgcmjceApplicationTestsContextInitializer.registerTomcatWebSocketConfiguration_websocketServletWebServerCustomizer(beanFactory);
    ...
    org.springframework.boot.autoconfigure.web.servlet.AesgcmjceApplicationTestsContextInitializer.registerServletWebServerFactoryConfiguration_EmbeddedTomcat(beanFactory);
    org.springframework.boot.autoconfigure.web.servlet.AesgcmjceApplicationTestsContextInitializer.registerEmbeddedTomcat_tomcatServletWebServerFactory(beanFactory);
    ...
    org.springframework.boot.context.properties.AesgcmjceApplicationTestsContextInitializer.registerConfigurationPropertiesBinder_Factory(beanFactory);
    org.springframework.boot.context.properties.AesgcmjceApplicationTestsContextInitializer.registerConfigurationPropertiesBinder(beanFactory);
    ...
    org.springframework.boot.autoconfigure.web.servlet.AesgcmjceApplicationTestsContextInitializer.registerDispatcherServletAutoConfiguration_DispatcherServletConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.web.servlet.AesgcmjceApplicationTestsContextInitializer.registerDispatcherServletConfiguration_dispatcherServlet(beanFactory);
    ...
    org.springframework.boot.autoconfigure.web.servlet.AesgcmjceApplicationTestsContextInitializer.registerDispatcherServletAutoConfiguration_DispatcherServletRegistrationConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.web.servlet.AesgcmjceApplicationTestsContextInitializer.registerDispatcherServletRegistrationConfiguration_dispatcherServletRegistration(beanFactory);
    ...
    org.springframework.boot.autoconfigure.jackson.AesgcmjceApplicationTestsContextInitializer.registerJacksonAutoConfiguration_Jackson2ObjectMapperBuilderCustomizerConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.jackson.AesgcmjceApplicationTestsContextInitializer.registerJackson2ObjectMapperBuilderCustomizerConfiguration_standardJacksonObjectMapperBuilderCustomizer(beanFactory);
    ...
    org.springframework.boot.autoconfigure.jackson.AesgcmjceApplicationTestsContextInitializer.registerJacksonAutoConfiguration_JacksonObjectMapperBuilderConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.jackson.AesgcmjceApplicationTestsContextInitializer.registerJacksonObjectMapperBuilderConfiguration_jacksonObjectMapperBuilder(beanFactory);
    org.springframework.boot.autoconfigure.jackson.AesgcmjceApplicationTestsContextInitializer.registerJacksonAutoConfiguration_ParameterNamesModuleConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.jackson.AesgcmjceApplicationTestsContextInitializer.registerParameterNamesModuleConfiguration_parameterNamesModule(beanFactory);
    org.springframework.boot.autoconfigure.jackson.AesgcmjceApplicationTestsContextInitializer.registerJacksonAutoConfiguration_JacksonObjectMapperConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.jackson.AesgcmjceApplicationTestsContextInitializer.registerJacksonObjectMapperConfiguration_jacksonObjectMapper(beanFactory);
    ...
    org.springframework.boot.autoconfigure.http.codec.AesgcmjceApplicationTestsContextInitializer.registerCodecsAutoConfiguration_DefaultCodecsConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.http.codec.AesgcmjceApplicationTestsContextInitializer.registerDefaultCodecsConfiguration_defaultCodecCustomizer(beanFactory);
    org.springframework.boot.autoconfigure.http.codec.AesgcmjceApplicationTestsContextInitializer.registerCodecsAutoConfiguration_JacksonCodecConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.http.codec.AesgcmjceApplicationTestsContextInitializer.registerJacksonCodecConfiguration_jacksonCodecCustomizer(beanFactory);
    ...
    org.springframework.boot.autoconfigure.web.servlet.error.AesgcmjceApplicationTestsContextInitializer.registerErrorMvcAutoConfiguration_WhitelabelErrorViewConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.web.servlet.error.AesgcmjceApplicationTestsContextInitializer.registerWhitelabelErrorViewConfiguration_error(beanFactory);
    org.springframework.boot.autoconfigure.web.servlet.error.AesgcmjceApplicationTestsContextInitializer.registerWhitelabelErrorViewConfiguration_beanNameViewResolver(beanFactory);
    org.springframework.boot.autoconfigure.web.servlet.error.AesgcmjceApplicationTestsContextInitializer.registerErrorMvcAutoConfiguration_DefaultErrorViewResolverConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.web.servlet.error.AesgcmjceApplicationTestsContextInitializer.registerDefaultErrorViewResolverConfiguration_conventionErrorViewResolver(beanFactory);
    ...
    org.springframework.boot.autoconfigure.web.servlet.error.AesgcmjceApplicationTestsContextInitializer.registerErrorMvcAutoConfiguration_errorPageCustomizer(beanFactory);
    org.springframework.boot.autoconfigure.web.servlet.error.AesgcmjceApplicationTestsContextInitializer.registerErrorMvcAutoConfiguration_preserveErrorControllerTargetClassPostProcessor(beanFactory);
    org.springframework.boot.autoconfigure.web.servlet.AesgcmjceApplicationTestsContextInitializer.registerWebMvcAutoConfiguration_EnableWebMvcConfiguration(beanFactory);
    ...
    org.springframework.boot.autoconfigure.web.servlet.AesgcmjceApplicationTestsContextInitializer.registerEnableWebMvcConfiguration_welcomePageHandlerMapping(beanFactory);
    ...
    org.springframework.boot.autoconfigure.web.servlet.AesgcmjceApplicationTestsContextInitializer.registerWebMvcAutoConfiguration_WebMvcAutoConfigurationAdapter(beanFactory);
    ...
    org.springframework.boot.autoconfigure.jdbc.AesgcmjceApplicationTestsContextInitializer.registerDataSourceConfiguration_Hikari(beanFactory);
    org.springframework.boot.autoconfigure.jdbc.AesgcmjceApplicationTestsContextInitializer.registerHikari_dataSource(beanFactory);
    org.springframework.boot.autoconfigure.jdbc.AesgcmjceApplicationTestsContextInitializer.registerDataSourceJmxConfiguration_Hikari(beanFactory);
    org.springframework.boot.autoconfigure.jdbc.AesgcmjceApplicationTestsContextInitializer.registerDataSourceJmxConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.jdbc.AesgcmjceApplicationTestsContextInitializer.registerDataSourceAutoConfiguration_PooledDataSourceConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.jdbc.metadata.AesgcmjceApplicationTestsContextInitializer.registerDataSourcePoolMetadataProvidersConfiguration_HikariPoolDataSourceMetadataProviderConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.jdbc.metadata.AesgcmjceApplicationTestsContextInitializer.registerHikariPoolDataSourceMetadataProviderConfiguration_hikariPoolDataSourceMetadataProvider(beanFactory);
    ...
    org.springframework.boot.autoconfigure.http.AesgcmjceApplicationTestsContextInitializer.registerHttpMessageConvertersAutoConfiguration_StringHttpMessageConverterConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.http.AesgcmjceApplicationTestsContextInitializer.registerStringHttpMessageConverterConfiguration_stringHttpMessageConverter(beanFactory);
    org.springframework.boot.autoconfigure.http.AesgcmjceApplicationTestsContextInitializer.registerJacksonHttpMessageConvertersConfiguration_MappingJackson2HttpMessageConverterConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.http.AesgcmjceApplicationTestsContextInitializer.registerMappingJackson2HttpMessageConverterConfiguration_mappingJackson2HttpMessageConverter(beanFactory);
    org.springframework.boot.autoconfigure.http.AesgcmjceApplicationTestsContextInitializer.registerJacksonHttpMessageConvertersConfiguration(beanFactory);
    ...
    org.springframework.boot.autoconfigure.jdbc.AesgcmjceApplicationTestsContextInitializer.registerJdbcTemplateConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.jdbc.AesgcmjceApplicationTestsContextInitializer.registerJdbcTemplateConfiguration_jdbcTemplate(beanFactory);
    org.springframework.boot.autoconfigure.jdbc.AesgcmjceApplicationTestsContextInitializer.registerNamedParameterJdbcTemplateConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.jdbc.AesgcmjceApplicationTestsContextInitializer.registerNamedParameterJdbcTemplateConfiguration_namedParameterJdbcTemplate(beanFactory);
    ...
    org.springframework.boot.sql.init.dependency.AesgcmjceApplicationTestsContextInitializer.registerDatabaseInitializationDependencyConfigurer_DependsOnDatabaseInitializationPostProcessor(beanFactory);
    ...
    org.springframework.boot.autoconfigure.sql.init.AesgcmjceApplicationTestsContextInitializer.registerDataSourceInitializationConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.sql.init.AesgcmjceApplicationTestsContextInitializer.registerDataSourceInitializationConfiguration_dataSourceScriptDatabaseInitializer(beanFactory);
    ...
    org.springframework.boot.autoconfigure.jdbc.AesgcmjceApplicationTestsContextInitializer.registerDataSourceTransactionManagerAutoConfiguration_JdbcTransactionManagerConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.jdbc.AesgcmjceApplicationTestsContextInitializer.registerJdbcTransactionManagerConfiguration_transactionManager(beanFactory);
    ...
    org.springframework.transaction.annotation.AesgcmjceApplicationTestsContextInitializer.registerProxyTransactionManagementConfiguration(beanFactory);
    ...
    org.springframework.boot.autoconfigure.web.reactive.function.client.AesgcmjceApplicationTestsContextInitializer.registerClientHttpConnectorConfiguration_ReactorNetty(beanFactory);
    org.springframework.boot.autoconfigure.web.reactive.function.client.AesgcmjceApplicationTestsContextInitializer.registerReactorNetty_reactorClientResourceFactory(beanFactory);
    org.springframework.boot.autoconfigure.web.reactive.function.client.AesgcmjceApplicationTestsContextInitializer.registerReactorNetty_reactorClientHttpConnector(beanFactory);
    ...
    org.springframework.boot.autoconfigure.web.reactive.function.client.AesgcmjceApplicationTestsContextInitializer.registerWebClientAutoConfiguration_WebClientCodecsConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.web.reactive.function.client.AesgcmjceApplicationTestsContextInitializer.registerWebClientCodecsConfiguration_exchangeStrategiesCustomizer(beanFactory);
    ...
    org.springframework.boot.autoconfigure.web.servlet.AesgcmjceApplicationTestsContextInitializer.registerHttpEncodingAutoConfiguration_localeCharsetMappingsCustomizer(beanFactory);
