...
import org.springframework.boot.test.autoconfigure._FactoryProvider;
...
public abstract class StaticSpringFactories {
  ...
  static {
    ...
    factories.add(DefaultTestExecutionListenersPostProcessor.class, () -> _FactoryProvider.springBootDependencyInjectionTestExecutionListenerPostProcessor());
