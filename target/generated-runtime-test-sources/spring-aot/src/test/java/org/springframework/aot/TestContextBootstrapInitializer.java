...
public class TestContextBootstrapInitializer {
  public static Map<String, Supplier<SmartContextLoader>> getContextLoaders() {
    ...
    entries.put("com.groww.tink.aesgcmjce.AesgcmjceApplicationTests", () -> new AotSpringBootConfigContextLoader(AesgcmjceApplicationTestsContextInitializer.class, WebApplicationType.SERVLET, SpringBootTest.WebEnvironment.MOCK));
    return entries;
  }
  ...
  public static Map<String, Class<? extends ApplicationContextInitializer<?>>> getContextInitializers(
    ...
    entries.put("com.groww.tink.aesgcmjce.AesgcmjceApplicationTests", AesgcmjceApplicationTestsContextInitializer.class);
    return entries;
  }
}
