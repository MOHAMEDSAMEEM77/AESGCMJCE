...
public final class AesgcmjceApplicationTestsContextInitializer {
  ...
  public static void registerJdbcTransactionManagerConfiguration_transactionManager(
      DefaultListableBeanFactory beanFactory) {
    BeanDefinitionRegistrar.of("transactionManager", DataSourceTransactionManager.class).withFactoryMethod(DataSourceTransactionManagerAutoConfiguration.JdbcTransactionManagerConfiguration.class, "transactionManager", Environment.class, DataSource.class, ObjectProvider.class)
        .instanceSupplier((instanceContext) -> instanceContext.create(beanFactory, (attributes) -> beanFactory.getBean(DataSourceTransactionManagerAutoConfiguration.JdbcTransactionManagerConfiguration.class).transactionManager(attributes.get(0), attributes.get(1), attributes.get(2)))).register(beanFactory);
  }
}
