...
public final class AesgcmjceApplicationTestsContextInitializer {
  ...
  public static void registerReactorNetty_reactorClientResourceFactory(
      DefaultListableBeanFactory beanFactory) {
    BeanDefinitionRegistrar.of("reactorClientResourceFactory", ReactorResourceFactory.class).withFactoryMethod(ClientHttpConnectorConfiguration.ReactorNetty.class, "reactorClientResourceFactory")
        .instanceSupplier(() -> beanFactory.getBean(ClientHttpConnectorConfiguration.ReactorNetty.class).reactorClientResourceFactory()).register(beanFactory);
  }
